...
## Table of Contents
- [Introduction](https://github.com/belur02/book/blob/master/Content/introduction.md)
...
you are supposed to keep an eye on FC's the moments the customer is coming you have
to observe the FC's is talking to the customer what is mention in the voice message
...
7. Example :- If the customer has purchased because of  price then u have to  tick   on price in the customer feedback book, if the customer has not purchased because of price u have to tick  on price, if for variety, quality, fit, service, then u have to follow same procedure as its mention.
...
Iam sure that you will not find the same product cheaper than our store
